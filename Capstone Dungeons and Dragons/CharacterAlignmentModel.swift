...
class CharacterAlignmentModel: ObservableObject {
    ...
    @Published var urlString = "https://dnd5eapi.co/api/alignments"
    @Published var count = 0
    @Published var alignmentArray: [Result] = []
    ...
    func getData() async {
        ...
        do {
            ...
            self.alignmentArray = returned.results
