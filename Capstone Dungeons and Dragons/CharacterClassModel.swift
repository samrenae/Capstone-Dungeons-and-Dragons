...
class CharacterClassModel: ObservableObject {
    ...
    @Published var urlString = "https://dnd5eapi.co/api/classes"
    @Published var count = 0
    @Published var classArray: [Result] = []
    ...
    func getData() async {
        ...
        do {
            ...
            self.classArray = returned.results
